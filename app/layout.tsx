            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
              ...
              <div>
                ...
                <div className="flex flex-col gap-2">
                  {["Compress", "Merge", "Split", "Reorder", "Rotate", "PDF to Image", "Image to PDF", "Watermark", "Page Numbers", "Extract Text", "Protect", "Edit Metadata"].map((t) => (
                    <a key={t} href={`/tools/${t.toLowerCase().replace(/ /g, "-")}`} className="text-sm font-body text-bolt-muted hover:text-bolt-accent transition-colors">
                      {t}
                    </a>
                  ))}
                </div>
